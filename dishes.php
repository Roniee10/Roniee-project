...
<head>
    ...
    <link rel="icon" href="#">
    <title>Dishes || Bakery Management System</title>
    ...
    <style>
        ...
        .widget-body .price-wrap p {
            margin-bottom: 10px;
        }

        .widget-body .price-wrap .btn {
            margin-top: 10px;
        }

        /* Menu widget styles */
        .menu-widget .widget-heading h3 {
            font-size: 28px;
            margin-bottom: 20px;
        }
        ...
        .menu-widget .food-item:last-child {
            border-bottom: none;
            padding-bottom: 0;
            margin-bottom: 0;
        }

        .menu-widget .food-item .item-img img {
            max-width: 100%;
            height: auto;
        }
        ...
        .menu-widget .food-item .rest-descr p {
            font-size: 14px;
            color: #777;
        }
        ...
        .menu-widget .food-item .item-cart-info .price {
            font-size: 20px;
            font-weight: bold;
            color: #f68b1f;
            margin-bottom: 10px;
        ...
        .menu-widget .food-item .item-cart-info .form-control {
            width: 80px;
            margin-right: 10px;
        }
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo.png" alt="" width="20%"> </a>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-lg-8">
                                        <form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-right">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        <span class="price pull-right">Rs <?php echo $product['price']; ?></span>
                                        <input class="b-r-0" type="text" name="quantity" style="margin-right:30px;" value="1" size="2" />
                                        <input type="submit" class="btn theme-btn custom-btn" value="Add To Cart" />
