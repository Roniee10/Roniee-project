            ...
            <div class="text-xs-center">
                ...
                <div class="row how-it-works-solution">
                    ...
                    <!-- <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div the main system is followed by the main roller 
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img'.$rows['.'].'" alt="Bakery logo"> </a>
																</div>
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?res_id='.$rows['rs_id'].'" >'.$rows[''].'</a>Delicious Bakery</h5>Kharibot-16,Kathmandu <span>'.$rows['.'].'</span>
																</div>
